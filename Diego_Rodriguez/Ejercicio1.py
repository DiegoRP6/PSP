...
#-El productor produce números enteros mayor que 100 y menor que 500, el tiempo de espera entre la generación de 
#un número y otro es de PT segundos (1 punto)

#-El consumidor lee X números de la cola de golpe, calcula la multiplicación de esos X números .(1 punto).
#el tiempo de espera entre la lectura de X elementos cola y la siguiente lectura de los siguientes X elementos 
#es de  CT segundos (1 punto)
...
#NOTA DAR UN PEQUEÑO TIEMPO ENTRE EL START DE CADA CONSUMIDOR Y/O PRODUCTOR Y EL SIGUIENTE PARA 
#PODER VER BIEN LOS MENSAJES DEL PRINT
...
class Productor(threading.Thread):
    ...
    def run(self):
        while True:
            for _ in range(10):
                self.queue.put(random.randint(10,500))
                time.sleep(self.PT)
...
if __name__ == "__main__":
    ...
    def apartado2():
        # Relación 4:2 con PT=2, CT=2 y X=2
        PT_4_2 = 2
        CT_4_2 = 2
        X_4_2 = 2
        relacion_4_2 = 4
